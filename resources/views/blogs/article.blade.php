            ...
            <div class="col-md-9 col-sm-9">
                ...
                <div class="row b-comment">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 b-comment-box">
                        @guest
                            <img class="b-head-img" src="{{ URL::asset('images/home/default_head_img.gif') }}" alt="{{ $config['WEB_NAME'] }}" title="{{ $config['WEB_NAME'] }}">
                        @else
                            <img class="b-head-img" src="{{ URL::asset(Auth::user()->avatar) }}" alt="{{ $config['WEB_NAME'] }}" title="{{ $config['WEB_NAME'] }}">
                        @endguest
                        <div class="b-box-textarea">
                            @guest
                                <div class="b-box-content js-hint" contenteditable="false">请先登录再发表评论</div>
                            @else
                                <div class="b-box-content js-hint" contenteditable="true">等待您的评论</div>
                            @endguest
                            ...
                            <div class="col-xs-10 col-sm-11 col-md-11 col-lg-11 b-content-col b-cc-first">
                                ...
                                @foreach($v['child'] as $m => $n)
                                    <div id="comment-{{ $n['id'] }}" class="row b-user b-child">
                                        <div class="col-xs-2 col-sm-1 col-md-1 col-lg-1 b-pic-col">
                                            <img class="b-user-pic js-head-img" src="{{ asset($n['avatar']) }}" alt="{{ $config['WEB_NAME'] }}" title="{{ $config['WEB_NAME'] }}">
                                        </div>
...
{{-- url('comment') 会去调用IndexController的comment函数  --}}
@section('js')
    <script>
        // 添加行数
